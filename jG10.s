...
#$ -q gpu@qa-1080ti-004    # Specify queue (use ‘debug’ for development)
#$ -l gpu_card=1    # Specify number of GPU cards
#$ -N not_10_2       # Specify job name

module load python/3.6.0 torch    # Required modules
#source /opt/crc/c/caffe/1.0.0-rc5/1.0.0
#python mydebug.py
setenv CUDA_VISIBLE_DEVICES 3
python3 -u trainer.py --arch=resnet20_20bce_beforeavg --save-dir=save_resnet20_10_2 --weightForNot 0.50
