...
def main():
    ...
    for epoch in range(1):
        ...
        #train(train_loader, model, criterion, optimizer, epoch, criterion2)
        #lr_scheduler.step()
...
def train(train_loader, model, criterion, optimizer, epoch, criterion2):
    """
        Run one train epoch
    """
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        loss2 = criterion2(output2, target_var_2)
        #print(args.weightForNot)
        #print('loss2: {}'.format(loss2))
        #print('loss1: {}'.format(loss1))
        loss = loss1+args.weightForNot*loss2
        ...
        if i % args.print_freq == 0:
            print('Epoch: [{0}][{1}/{2}]\t'
                  ...
                  'Prec@1 {top1.val:.3f} ({top1.avg:.3f})'.format(
                      ...
                      data_time=data_time, loss=losses, top1FromNot=top1FromNot, top1=top1))
...
def validate(val_loader, model, criterion):
    ...
    top1FromNot = AverageMeter()
    top3 = AverageMeter()
    top3FromNot = AverageMeter()
    top5 = AverageMeter()
    top5FromNot = AverageMeter()
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        #print(len(output2List))
        #print(len(output2List[0]))
        ...
        prec1 = accuracy(output1.data, target)[0]
        prec2 = accuracy2(output2.data, target)[0]
        prec1_3 = accuracy(output1.data, target)[1]
        prec2_3 = accuracy2(output2.data, target)[1]
        prec1_5 = accuracy(output1.data, target)[2]
        prec2_5 = accuracy2(output2.data, target)[2]
        losses.update(loss1.data[0], input.size(0))
        top1.update(prec1[0], input.size(0))
        top1FromNot.update(prec2[0], input.size(0))
        top3.update(prec1_3[0], input.size(0))
        top3FromNot.update(prec2_3[0], input.size(0))
        top5.update(prec1_5[0], input.size(0))
        top5FromNot.update(prec2_5[0], input.size(0))
    ...
    print(' * Prec@1 {top1.avg:.3f}'
          .format(top1=top1))
    print(' * Prec@1FromNot {top1FromNot.avg:.3f}'
          .format(top1FromNot=top1FromNot))
    print(' * Prec@3 {top3.avg:.3f}'
          .format(top3=top3))
    print(' * Prec@3FromNot {top3FromNot.avg:.3f}'
          .format(top3FromNot=top3FromNot))
    print(' * Prec@5 {top5.avg:.3f}'
          .format(top5=top5))
    print(' * Prec@5FromNot {top5FromNot.avg:.3f}'
          .format(top5FromNot=top5FromNot))
    print(len(res))
    print(len(res[0]))
    
    npres = np.asarray(res)
    np.save('res.npy', npres)
...
def accuracy2(output, target, topk=(1,3,5)):
